                ...
                try {
                  ...
                  if (json) {
                    ...
                    if (json_text) {
                      ...
                      let parser = new DOMParser();
                      let doc = parser.parseFromString('<div id="endOfArticle">' + DOMPurify.sanitize(json_text, dompurify_options) + '</div>', 'text/html');
...
} else if (window.location.hostname.match(/\.(ar|br|cl|mx|pe|uy)$/) || matchDomain(['abcmais.com', 'cambiocolombia.com', 'clarin.com', 'cronista.com', 'elespectador.com', 'elmercurio.com', 'eltiempo.com', 'eltribuno.com', 'exame.com', 'globo.com', 'latercera.com', 'revistaoeste.com'])) {//south america
