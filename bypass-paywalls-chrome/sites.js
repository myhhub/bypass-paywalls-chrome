var defaultSites = {
  ...
  "American Affairs": {
    ...
    allow_cookies: 1,
    block_regex:
      /\/americanaffairsjournal\.org\/wp-content\/mu-plugins\/app\/src\/paywall\/paywall\.js/,
  },
  ...
  Artnet: {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.artnet\.com\/paywall-ajax\.php|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
  },
  "Ärzte Zeitung": {
  ...
  "Australia Nine Entertainment": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.piano\.io\/xbuilder\/experience\/execute|\.cxense\.com\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
    exception: [
      {
        domain: "afr.com",
        allow_cookies: 1,
  ...
  Bloomberg: {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.cm\.bloomberg\.com\/|assets\.bwbx\.io\/s\d\/javelin\/.+\/transporter\/)/,
  },
  "Bloomberg Adria": {
  ...
  "Business Insider": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.businessinsider\.com\/chunks\/scripts\/\d.+\.js|\.sophi\.io\/)/,
  },
  ...
  "California Business Journals": {
    domain: "###_usa_cbj",
    group: ["labusinessjournal.com", "ocbj.com", "sdbj.com", "sfvbj.com"],
    allow_cookies: 1,
  ...
  "CH Media (opt-in to custom sites for unlisted)": {
    domain: "###_ch_media",
    group: ["aargauerzeitung.ch", "luzernerzeitung.ch", "tagblatt.ch"],
    allow_cookies: 1,
  ...
  "Connaissance des Arts": {
    ...
    allow_cookies: 1,
    block_regex:
      /\.connaissancedesarts\.com\/wp-content\/.+\/vendor\/iptools-jquery-inview\.min\.js/,
  },
  "Correio do Povo": {
    domain: "correiodopovo.com.br",
    allow_cookies: 1,
    block_regex:
      /(paywall\.correiodopovo\.com\.br|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  "Corriere della Sera": {
    domain: "corriere.it",
    allow_cookies: 1,
    block_regex:
      /(\.tinypass\.com\/|\.corriereobjects\.it\/.+\/js\/_paywall\.sjs|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
  },
  ...
  "Crain Communications": {
    ...
    allow_cookies: 1,
    block_regex:
      "(js\\.pelcro\\.com\\/|{domain}\\/profiles\\/.+\\/crain_pelcro_user\\.js)",
    exception: [
      {
        domain: "autonews.com",
        allow_cookies: 1,
  ...
  "Daily Mail Group UK": {
    ...
    group: ["dailymail.co.uk", "mailonsunday.co.uk", "thisismoney.co.uk"],
    allow_cookies: 1,
  ...
  "Digiday Media": {
    domain: "###_usa_digiday",
    group: ["digiday.com", "glossy.co", "modernretail.co"],
    allow_cookies: 1,
    block_regex: /\.tinypass\.com\//,
  },
  "DigiTimes Asia": {
  ...
  "DPG Media (not ADR)": {
    ...
    block_regex:
      "(\\.{domain}\\/temptation\\/resolve|temptation\\.{domain}\\/temptation\\.js)",
  },
  ...
  "El Español": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.tinypass\.com\/|\.ampproject\.org\/v0\/amp-(access|subscriptions)-.+\.js)/,
  },
  "El Espectador": {
    domain: "elespectador.com",
    allow_cookies: 1,
    block_regex:
      /(\.tinypass\.com\/|\.cxense\.com\/|js\.matheranalytics\.com\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
  },
  "El Mercurio (not Inversiones/Legal; + regional/opt-in to custom sites)": {
    domain: "elmercurio.com",
    group: ["elmercurio.com"],
    block_regex:
      "(\\.{domain}\\/impresa\\/.+\\/assets\\/(vendor|\\d)\\.js|pram\\.pasedigital\\.cl\\/API\\/User\\/Status\\?)",
    exception: [
      {
        domain: "elmercurio.com",
        allow_cookies: 1,
        block_regex:
          /\.(elmercurio\.com|emol\.cl)\/(.+\/)?js\/(.+\/)?(modal|merPramV\d|PramModal\.min)\.js/,
        useragent: "googlebot",
      },
    ],
  },
  "El Observador.com.uy": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.elobservador\.com\.uy\/shares|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  "El País": {
    domain: "elpais.com",
    allow_cookies: 1,
    ...
    block_regex:
      /(\/elpais\.com\/arc\/subs\/p\.min\.js|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  "El País.com.uy": {
    domain: "elpais.com.uy",
    allow_cookies: 1,
    block_regex:
      /(\.elpais\.com\.uy\/user\/authStatus|\.evolok\.net\/|\.cxense\.com\/)/,
  },
  "El Tiempo": {
    domain: "eltiempo.com",
    allow_cookies: 1,
  ...
  "Forbes (not newsletters)": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.forbes\.com\/zephr\/feature|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  "Forbes Australia": {
  ...
  "Foreign Affairs (not reader)": {
    ...
    allow_cookies: 1,
    block_regex:
      /\.foreignaffairs\.com\/modules\/custom\/fa_paywall_js\/js\/paywall\.js/,
  },
  "Foreign Policy": {
  ...
  Fortune: {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.piano\.io\/xbuilder\/experience\/execute|\.cxense\.com\/|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  ...
  "Gazeta do Povo": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.tinypass\.com\/|\.cxense\.com\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
  },
  "GB News": {
    domain: "gbnews.com",
    allow_cookies: 1,
  ...
  "Groupe IPM": {
    ...
    group: ["dhnet.be", "lalibre.be", "lavenir.net"],
    allow_cookies: 1,
    block_regex:
      /(\.piano\.io\/xbuilder\/experience\/execute|\.cxense\.com\/|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  ...
  "Groupe Nice-Matin": {
    ...
    group: ["monacomatin.mc", "nicematin.com", "varmatin.com"],
    allow_cookies: 1,
    block_regex:
      /(\.qiota\.com\/|\.nicematin\.com\/build\/js\/viewpay\..+\.js)/,
  },
  "Groupe Profession Santé": {
    domain: "###_fr_groupe_prof_sante",
    group: ["lequotidiendumedecin.fr", "lequotidiendupharmacien.fr"],
    allow_cookies: 1,
    block_regex: /\.poool\.fr\//,
  },
  "Groupe Québecor": {
    domain: "###_ca_groupe_quebecor",
    group: ["journaldemontreal.com", "journaldequebec.com"],
    allow_cookies: 1,
  },
  "Groupe Sud Ouest": {
    domain: "###_fr_groupe_sud_ouest",
    group: ["sudouest.fr", "charentelibre.fr", "larepubliquedespyrenees.fr"],
    allow_cookies: 1,
  },
  ...
  "Grupo Clarín": {
    ...
    group: ["clarin.com", "lavoz.com.ar", "losandes.com.ar", "ole.com.ar"],
    allow_cookies: 1,
    ...
    exception: [
      {
        ...
        allow_cookies: 1,
        block_regex:
          /cdn\.lavoz\.com\.ar\/sites\/.+\/paywall\/losandes\/pw\.js/,
      },
    ],
  },
  "Grupo El Comercio": {
    domain: "###_pe_grupo_elcomercio",
    group: ["diariocorreo.pe", "elcomercio.pe", "gestion.pe"],
    allow_cookies: 1,
    block_regex:
      "(\\.tinypass\\.com\\/|\\/{domain}\\/pf\\/dist\\/engine\\/react\\.js)",
  },
  ...
  "Grupo Unidad Editorial": {
    domain: "###_es_unidad",
    group: ["elmundo.es", "expansion.com", "marca.com"],
    allow_cookies: 1,
    block_regex:
      /(\.tinypass\.com\/|\.ampproject\.org\/v0\/amp-(access|subscriptions)-.+\.js)/,
  },
  ...
  "Gruppo SAE.it (free articles only; opt-in to custom sites for unlisted)": {
    ...
    group: ["iltirreno.it", "lanuovasardegna.it"],
  },
  "Haaretz Group (no menu/footer)": {
    domain: "###_il_haaretz_group",
    group: ["haaretz.co.il", "haaretz.com", "themarker.com"],
    ...
    useragent_custom:
      "Mozilla/5.0 (Linux; Android 9) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.6668.70 Safari/537.36 haaretz/5.0.49",
  },
  "Haas Mediengruppe (opt-in to custom sites for unlisted)": {
    domain: "###_de_haas_medien",
    group: ["mannheimer-morgen.de"],
    allow_cookies: 1,
    useragent: "googlebot",
  },
  ...
  "Haymarket Medical Network (opt-in to custom sites)": {
    ...
    remove_cookies: 1,
    cs_code: [
      { cond: "div#modal-register-popup, div.gating-banner", rm_elem: 1 },
      { cond: "div[data-gated]", rm_attrib: "data-gated" },
    ],
  },
  "Hearst Communications (newspapers; opt-in to custom sites for unlisted)": {
    ...
    allow_cookies: 1,
    block_regex:
      "(\\.{domain}\\/script\\.js|\\.ensighten\\.com\\/|js\\.matheranalytics\\.com\\/)",
  },
  ...
  "Il Messaggero (+ regional)": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.(cedscdn|cedsdigital)\.it\/.+\/PaywallMeter\.js|\.ampproject\.org\/v0\/amp-(access|consent|subscriptions)-.+\.m?js)/,
  },
  ...
  Inc42: {
    ...
    allow_cookies: 1,
    block_regex:
      /(\/inc42\.com\/wp-admin\/admin-ajax\.php$|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  "India Today": {
  ...
  InvestSmart: {
    ...
    group: ["intelligentinvestor.com.au", "investsmart.com.au"],
    allow_cookies: 1,
    useragent: "googlebot",
  },
  ...
  "L'Oeil de la Photographie": {
    ...
    allow_cookies: 1,
    block_regex:
      /cdn\.loeildelaphotographie\.com\/wp-content\/.+\/hague-child\/js\/script-.+\.js/,
  },
  ...
  "La Croix": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.la-croix\.com\/build\/.+\/paywall.+\.js|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  "La Diaria.com.uy": {
  ...
  Landwirtschaftsverlag: {
    domain: "###_de_lv",
    group: ["profi.de", "topagrar.com", "wochenblatt.com"],
    allow_cookies: 1,
    exception: [
      {
        domain: "topagrar.com",
  ...
  "Las Vegas Review-Journal": {
    ...
    allow_cookies: 1,
    block_regex:
      /\.reviewjournal\.com\/wp-content\/plugins\/.+\/loader_prod\.min\.js/,
  },
  ...
  "LiveMint (not epaper)": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.livemint\.com\/lm-img\/subscription\/|\.tinypass\.com\/|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  ...
  MarketWatch: {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.cxense\.com\/|\.ampproject\.org\/v0\/amp-(access|subscriptions)-.+\.js)/,
  },
  "McClatchy Group (opt-in to custom sites for unlisted)": {
    ...
    block_regex:
      /(\.amplitude\.com\/|\.mcclatchy\.com\/mcc-paywall-new\.js|\.ampproject\.org\/v0\/amp-(access|subscriptions)-.+\.js)/,
  },
  ...
  "Mediahuis België (fetch from archive.is)": {
    ...
    group: ["gva.be", "hbvl.be", "nieuwsblad.be", "standaard.be"],
    allow_cookies: 1,
    block_regex:
      "\\.{domain}\\/extra\\/assets\\/resources\\/js\\/zephrIntegration\\.js",
    cs_dompurify: 1,
  },
  ...
  "MediaNews Group (opt-in to custom sites for unlisted)": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.com\/(script|.+\/loader\.min)\.js|\.tinypass\.com\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
    cs_dompurify: 1,
  },
  "Medium (opt-in to custom sites for custom domains)": {
    domain: "medium.com",
    allow_cookies: 1,
    group: ["medium.com", "betterprogramming.pub", "towardsdatascience.com"],
  },
  "Medscape (regwall)": {
    domain: "medscape.com",
    allow_cookies: 1,
    block_regex:
      /(\.medscapestatic\.com\/.+\/medscape-library|\.wbmdstatic\.com\/.+\/chunk-vendors\..+)\.js/,
  },
  "Mexico News Daily": {
    domain: "mexiconewsdaily.com",
    allow_cookies: 1,
    block_regex:
      /\/mexiconewsdaily\.com\/wp-content\/plugins\/leaky-paywall\/js\/leaky-paywall-cookie\.js/,
  },
  "Mid-Day (not epaper)": {
    domain: "mid-day.com",
    allow_cookies: 1,
  ...
  "MIT Sloan Management Review": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.tinypass\.com\/|\/sloanreview\.mit\.edu\/.+\/welcome-ad\.js)/,
  },
  "MIT Technology Review": {
    domain: "technologyreview.com",
    allow_cookies: 1,
    block_regex:
      /(\.tinypass\.com\/|\.ampproject\.org\/v0\/amp-access-.+\.mjs)/,
  },
  Monocle: {
    domain: "monocle.com",
    useragent: "googlebot",
  ...
  "Nation Media Group (Kenya; opt-in to custom sites for unlisted)": {
    ...
    group: ["businessdailyafrica.com", "nation.africa"],
    allow_cookies: 1,
    cs_dompurify: 1,
  },
  ...
  "National World Publishing (UK; opt-in to custom sites for unlisted)": {
    ...
    group: ["scotsman.com", "yorkshirepost.co.uk"],
    allow_cookies: 1,
    block_regex: /\.tinypass\.com\//,
  },
  Nautilus: {
  ...
  "New Scientist": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.piano\.io\/|appan\.newscientist\.com\/pugpig-websmartbanner\.js)/,
    cs_all_frames: 1,
    cs_dompurify: 1,
  },
  "New Voice (nv.ua)": {
  ...
  "New York Magazine (+ Curbed, Grub Street, The Cut & Vulture)": {
    ...
    allow_cookies: 1,
    block_regex: /\.zeddit\.com\/.+\/SiteScript\.js/,
  },
  "New Zealand Herald": {
  ...
  Newsday: {
    ...
    allow_cookies: 1,
    block_regex:
      /(loader-cdn\.azureedge\.net\/|js\.matheranalytics\.com\/|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  Newslaundry: {
  ...
  Newsweek: {
    domain: "newsweek.com",
    block_regex:
      /(js\.pelcro\.com\/|\.ampproject\.org\/v0\/amp-(access|subscriptions)-.+\.js)/,
  },
  "Nikkei Asian Review": {
  ...
  "NSC Total": {
    ...
    allow_cookies: 1,
    block_regex:
      /\.nsctotal\.com\.br\/wp-content\/themes\/nsctotal\/js\/paywall\.js/,
  },
  ...
  "O Estado de S. Paulo": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.estadao\.com\.br\/(paywall\/|access\.js)|\.ampproject\.org\/v0\/amp-(access|subscriptions)-.+\.js)/,
  },
  "O Globo (& Valor Econômico)": {
    domain: "globo.com",
    allow_cookies: 1,
    block_regex:
      /(\.tinypass\.com\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
  },
  "Observador.pt": {
  ...
  "Paste Magazine": {
    ...
    allow_cookies: 1,
    block_regex:
      /\.pastemagazine\.com\/wp-content\/cache\/autoptimize\/js\/autoptimize_.+\.js/,
  },
  ...
  "Ringier Gruppe (ch)": {
    allow_cookies: 1,
    domain: "###_ch_ringier",
    group: ["beobachter.ch", "blick.ch", "handelszeitung.ch"],
    block_regex: /\.tinypass\.com\//,
    cs_dompurify: 1,
    useragent: "googlebot",
    exception: [
  ...
  "Roularta Media Group": {
    ...
    block_regex:
      "(\\.|\\/){domain}\\/(script|js\\/responsive\\/rmg(Modal|Paywall))\\.js",
    exception: [
      {
  ...
  "Tampa Bay Times": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.zephr\.com\/zephr-browser\/|js\.matheranalytics\.com\/|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  "Tech in Asia": {
  ...
  "TechTarget Group": {
    ...
    allow_cookies: 1,
    group: ["computerweekly.com", "lemagit.fr", "techtarget.com"],
  },
  Telegraaf: {
    domain: "telegraaf.nl",
    allow_cookies: 1,
  ...
  "The (New Orleans) Advocate": {
    ...
    group: ["nola.com", "shreveportbossieradvocate.com", "theadvocate.com"],
    allow_cookies: 1,
    block_regex:
      "(\\.{domain}\\/(script|.+\\/tncms\\/api\\/access\\..+)\\.js|\\.townnews\\.com\\/.+\\/engage\\.min\\.js)",
  },
  ...
  "The Art Newspaper": {
    ...
    allow_cookies: 1,
    block_regex:
      /\.theartnewspaper\.com\/_next\/static\/chunks\/pages\/access-allowed-.+\.js/,
  },
  "The Atlanta Journal-Constitution (+ Cox First Media/opt-in to custom sites)":
    {
      ...
      allow_cookies: 1,
      block_regex:
        /(\.wgchrrammzv\.com\/prod\/ajc\/loader\.min\.js|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
      exception: [
        {
          domain: "ajc.com",
          allow_cookies: 1,
          block_regex:
            /(\.piano\.io\/xbuilder\/experience\/execute|\.cxense\.com\/|\.sophi\.io\/)/,
        },
      ],
    },
  "The Atlantic": {
  ...
  "The Boston Globe": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.blueconic\.net\/|meter\.bostonglobe\.com\/js\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
  },
  ...
  "The Business of Fashion": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.businessoffashion\.com\/zephr\/feature|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  ...
  "The Chronicle of Higher Education (& Philanthropy)": {
    ...
    group: ["chronicle.com", "philanthropy.com"],
    allow_cookies: 1,
    block_regex: "\\.{domain}\\/script\\.js",
  },
  "The Columbian": {
  ...
  "The Dallas Morning News": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.dallasnews\.com\/script\.js|js\.matheranalytics\.com\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
    useragent: "googlebot",
  },
  "The Diplomat": {
  ...
  "The Economic Times (ET Prime)": {
    ...
    group: ["economictimes.com", "economictimes.indiatimes.com"],
    allow_cookies: 1,
    useragent: "googlebot",
    cs_dompurify: 1,
  },
  ...
  "The Epoch Times (+ br|cz|de|fr|jp|ro; opt-in to custom sites)": {
    ...
    group: ["epoch.org.il", "theepochtimes.com"],
    allow_cookies: 1,
    block_regex:
      /\.(theepochtimes\.com|epochbase\.(com|eu))\/(rules\/get|libs\/paywall.+\.js)/,
    exception: [
      {
        domain: "epoch.org.il",
        allow_cookies: 1,
  ...
  "The Financial Express": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.financialexpress\.com\/.+\/min\/premiumStoryContent\.js|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  "The Globe and Mail": {
  ...
  "The Hill Times": {
    ...
    allow_cookies: 1,
    block_regex:
      /\.hilltimes\.com\/.+\/js\/loadingoverlay\/loadingoverlay\.min\.js/,
    useragent: "googlebot",
    cs_dompurify: 1,
  },
  "The Hindu (not epaper)": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.cxense\.com\/|\.piano\.io\/xbuilder\/experience\/execute|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
  },
  ...
  "The Independent (UK & USA)": {
    ...
    group: ["independent.co.uk", "the-independent.com"],
    allow_cookies: 1,
    block_regex: /\.tinypass\.com\//,
  },
  "The Indian Express": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\/indianexpress\/js\/evolok\/|\.fewcents\.co\/.+\/paywall.*\.js|\.ampproject\.org\/v0\/amp-access-.+\.js)/,
  },
  ...
  "The Juggernaut": {
    ...
    group: ["thejuggernaut.com", "jgnt.co"],
    allow_cookies: 1,
  },
  "The Lamp Magazine": {
  ...
  "The New Atlantis": {
    ...
    allow_cookies: 1,
    block_regex:
      /\.thenewatlantis\.com\/.+\/thenewatlantis\/js\/(gate|donate)\.js/,
  },
  "The New Criterion": {
  ...
  "The New York Times": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.nytimes\.com\/(meter\.js|svc\/onsite-messaging\/query)|mwcm\.nyt\.com\/.+\.js|cooking\.nytimes\.com\/api\/.+\/access)/,
    useragent: "googlebot",
  },
  "The News Lens": {
    allow_cookies: 1,
  ...
  "The Saturday Paper": {
    ...
    block_regex:
      /\.thesaturdaypaper\.com\.au\/sites\/all\/modules\/custom\/node_meter\/pw\.js/,
  },
  ...
  "The Seattle Times": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.seattletimes\.com\/.+\/st-user-messaging.+\.js|js\.matheranalytics\.com\/)/,
  },
  "The Spectator (UK)": {
  ...
  "The Stage Media (UK)": {
    ...
    allow_cookies: 1,
    group: ["thebookseller.com", "thestage.co.uk"],
    cs_dompurify: 1,
    exception: [
      {
  ...
  "Ground News": {
    domain: "ground.news",
    allow_cookies: 1,
    block_regex: /(\.tinypass\.com\/|\.ground\.news\/martech\/js\/)/,
  },
  ...
  "The Toronto Star (+ local TorStar sites)": {
    ...
    allow_cookies: 1,
    block_regex:
      "(\\.{domain}\\/(script|.+\\/tncms\\/api\\/access\\..+)\\.js|\\.ampproject\\.org\\/v\\d\\/amp-access-.+\\.js)",
    cs_dompurify: 1,
  },
  "The Verge": {
    domain: "theverge.com",
  ...
  "Times of India": {
    ...
    group: ["epaper.indiatimes.com", "timesofindia.indiatimes.com"],
    allow_cookies: 1,
    cs_dompurify: 1,
  },
  ...
  "Tribune Publishing Company": {
    ...
    allow_cookies: 1,
    block_regex:
      "(\\.{domain}\\/(script|.+\\/loader-wp\\/static\\/loader\\.min)\\.js)",
    cs_dompurify: 1,
  },
  Tuttosport: {
  ...
  "UOL.com.br": {
    ...
    allow_cookies: 1,
    block_regex:
      /(paywall\.folha\.uol\.com\.br\/|\.(tinypass|matheranalytics)\.com\/|\.ampproject\.org\/v0\/amp-subscriptions-.+\.js)/,
    useragent: "googlebot",
  },
  "USA Today": {
    domain: "usatoday.com",
  ...
  "Verlagsgruppe Rhein Main (opt-in to custom sites for unlisted)": {
    allow_cookies: 1,
    domain: "###_de_vrm",
    group: ["allgemeine-zeitung.de", "echo-online.de", "wiesbadener-kurier.de"],
    allow_cookies: 1,
    block_regex: /\.cxense\.com\//,
    useragent: "googlebot",
  },
  ...
  "Winnipeg Free Press": {
    ...
    allow_cookies: 1,
    block_regex:
      /(\.winnipegfreepress\.com\/(api\/v\d\/auth\/identify|.+\/gdpr\.js)|\.cxense\.com\/)/,
  },
  Wonderzine: {
  ...
  "Amp-access": {
    ...
    allow_cookies: 1,
    block_regex_general:
      /\.ampproject\.org\/.+\/amp-(access|(.+-)?ad|analytics|fx-flying-carpet|subscriptions)-.+\.m?js/,
  ...
  BlueConic: {
    ...
    allow_cookies: 1,
    block_regex_general:
      /(\.blueconic\.net\/|[a-z]{1}[0-9]{2,3}\.[\w-]+\.(co(m|\.uk)|net|org)\/script\.js)/,
  },
  Cxense: {
    domain: "cxense.com",
    allow_cookies: 1,
...
var defaultSites_grouped_domains = Object.values(defaultSites)
  ...
  .map((x) => x.domain);
var defaultSites_groups_domains = [].concat.apply(
  [],
  Object.values(defaultSites)
    .filter(function (value) {
      return value.hasOwnProperty("group");
    })
    .map((x) => x.group)
);
var defaultSites_domains = defaultSites_grouped_domains.concat(
  defaultSites_groups_domains
);
...
function expandSiteRules(sites, updated = false) {
  for (let site in sites) {
    ...
    if (rule.hasOwnProperty("group_rule")) {
      ...
      for (key in rules) {
        if (key !== "group_rule_domains") sites[site][key] = rules[key];
      }
    ...
    if (updated) {
      if (rule.hasOwnProperty("group_rule_domains")) {
        ...
        for (let domain of domains) {
          let defaultTitle = Object.keys(defaultSites).find(
            (key) => defaultSites[key].domain === domain
          );
          if (defaultTitle) {
            for (key in rule) {
...
var custom_flex_nofix_domains = [].concat(
  custom_flex_not["###_wp_leaky_paywall"],
  custom_flex_not["###_uk_axate.io"]
);
...
var de_westfalen_medien_nofix_domains = [
  "muensterschezeitung.de",
  "westfalen-blatt.de",
  "wn.de",
];
var fi_sanoma_nofix_domains = ["aamulehti.fi", "hs.fi", "is.fi"];
var fr_groupe_ebra_nofix_domains = [
  "bienpublic.com",
  "dna.fr",
  "estrepublicain.fr",
  "lalsace.fr",
...
var fr_groupe_infopro_nofix_domains = [
  "centralbanking.com",
  "lagazettedescommunes.com",
  "risk.net",
  "usine-digitale.fr",
];
var fr_be_groupe_rossel_nofix_domains = [
  "aisnenouvelle.fr",
  "courrier-picard.fr",
  "lardennais.fr",
  "lavoixdunord.fr",
...
var fr_jamg_nofix_domains = [
  "africabusinessplus.com",
  "jeuneafrique.com",
  "theafricareport.com",
];
var fr_monde_diplo_nofix_domains = [
...
var it_gedi_nofix_domains = ["ilsecoloxix.it", "limesonline.com"];
var nl_mediahuis_region_nofix_domains = [
  "gooieneemlander.nl",
  "haarlemsdagblad.nl",
  "ijmuidercourant.nl",
  "leidschdagblad.nl",
...
var se_bonnier_group_nofix_domains = [
  "di.se",
  "dn.se",
  "expressen.se",
  "hd.se",
...
var nofix_sites = [
  ...
  custom_flex_nofix_domains,
  de_smn_nofix_domains,
  de_westfalen_medien_nofix_domains,
  fi_sanoma_nofix_domains,
  fr_groupe_ebra_nofix_domains,
  fr_groupe_infopro_nofix_domains,
  fr_be_groupe_rossel_nofix_domains,
  fr_indigo_nofix_domains,
  fr_jamg_nofix_domains,
  fr_monde_diplo_nofix_domains,
  it_gedi_nofix_domains,
  nl_mediahuis_region_nofix_domains,
  se_bonnier_group_nofix_domains
);
