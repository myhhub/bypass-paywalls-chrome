...
#### Android
1. Install [Quetta Browser](https://play.google.com/store/apps/details?id=net.quetta.browser) from the Google PlayStore.
2. You have two options:
* load the CRX-file from [GitFlic](https://gitflic.ru/project/magnolia1234/bpc_uploads) (auto-updating, no allowlist needed)
